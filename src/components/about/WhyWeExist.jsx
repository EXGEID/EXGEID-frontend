...
const WhyWeExist = () => {
    ...
    return (
        <section className="bg-[#09052C] flex">
            <FadeInSection type="slideDown" className="lg:mt-48 md:mt-36 mt-34 h-full"><img src={WhyWeExistBanner} alt="EXGEID Why We Exist Banner" className="lg:w-auto lg:h-auto w-[100%] h-[100%] ml-6 md:ml-0"/></FadeInSection>
            <FadeInSection type="slideUp" className="lg:mt-24 md:mt-16 mt-12 lg:mr-24 md:mr-16 mr-6 lg:ml-[-20px] lg:w-[40%]">
                ...
                <button onClick={() => navigate('?modal=signup')} className="bg-[#8F0406] hover:bg-red-700 hover:scale-105 text-white font-medium lg:px-4 md:px-3 px-2 lg:py-4 md:py-3 py-2 lg:w-48 md:w-32 w-20 rounded-md my-2 md:my-4 lg:text-[21.97px] md:text-[16px] text-[10.18px]">Signup</button>
            </FadeInSection>
        </section>
    );
};
