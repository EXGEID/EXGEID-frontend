...
const WhatWeDo = () => {
    return (
        <div className="bg-[#020109] grid md:grid-cols-2 lg:gap-12 md:gap-8 gap-6 lg:px-16 md:px-8 px-4">
            <FadeInSection type="slideDown" className="order-2 md:order-1 md:pt-48"><img src={WhatWeDoBanner} alt="EXGEID What We Do Banner"/></FadeInSection>
                    ...
                    {objectives.map((objective, i) => (
                        <div>
                            <div key={i} className="md:block hidden">
                                <Objective description={objective.description} type={"slideRight"} delay={i} />
                            </div>
                            <div key={i} className="md:hidden block">
                                <Objective description={objective.description} type={"zoom"} delay={i} />
                            </div>
                        </div>
                    ))}
                </div>
