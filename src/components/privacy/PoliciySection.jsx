...
const PolicySection = () => {
  return (
    <div className="bg-[#09052C] lg:py-32 items-center py-10 px-6 lg:px-56">
        <FadeInSection type="slideUp" className="mb-4 lg:mb-8 font-medium text-[#CACACA] lg:text-[18px] md:text-[14px] text-[10px]">
        ...
        <FadeInSection type="slideUp" className="mb-4 lg:mb-8 font-medium text-[#CACACA] lg:text-[18px] md:text-[14px] text-[10px] lg:w-[90%]">
            <div className="flex items-center">
        ...
        <FadeInSection type="slideUp" className="font-medium text-[#CACACA] lg:text-[18px] md:text-[14px] text-[10px] lg:w-[90%]">
            <div className="flex items-center">
