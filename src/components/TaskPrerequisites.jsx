...
const TaskPrerequisitesModal = ({ onClose }) => {
    ...
    >
      ...
      >
        <div className="overflow-hidden max-h-[80vh] px-4 md:px-8 py-12 md:pt-16 lg:pt-14 md:pb-16 lg:pb-16">
          <h2 className="lg:text-[32px] md:text-[27.92px] text-[24px] font-semibold text-[#E9E2E2] lg:mb-6 mb-2">Exgeid Task Prerequisites </h2>
          <div className="overflow-y-auto lg:max-h-[50vh] max-h-[60vh] pr-4 md:pr-12 text-[#CACACA] text-[12px] md:text-[16px] lg:text-[18px]">
            <p className="my-1 md:my-2">1. For YouTube related tasks, ensure that you have signed up with Gmail with the same email in your profile before; and allowed permissions - If you have not, click <a href="https://exgeid-backend.onrender.com/api/v1/auth/google" className="text-[#FEC84D] hover:text-yellow-200 underline">here</a>.</p>
...
export default TaskPrerequisitesModal;