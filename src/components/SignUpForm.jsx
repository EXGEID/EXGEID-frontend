...
import NigerianFlagIcon from "../assets/icons/flag.svg";
        ...
        <div className="overflow-y-auto max-h-[90vh] px-4 md:px-12 lg:px-28 py-12 md:pt-16 lg:pt-20 md:pb-16 lg:pb-36">
          ...
          <form className="mt-4 sm:mt-6">
            ...
            <div className="flex mt-1">
              <div className="bg-[#110B41] w-[33%] md:w-[20%] p-2 rounded-l-md flex items-center justify-center md:gap-2 gap-1 text-white font-regular md:text-[16px] text-[12px]">
                <img src={NigerianFlagIcon} alt="Nigerian Flag Icon" className="pt-1"/>
                <span className="pt-1">+234</span>
              </div>
              <input
                type="tel"
                placeholder="080...."
                className="w-full bg-[#09052C] text-white p-2 lg:px-4 py-3 md:py-4 rounded-r-md mt-1 font-regular md:text-[16px] text-[12px] focus:outline-none focus:border-[#FEC84D] focus:ring-1 focus:ring-[#FEC84D]"
                required
              />
            </div>
